...
export default function AdminDashboard() {
  ...
  return (
    <div className="fade-up" style={{ minHeight: 'calc(100vh - 60px)', display:'flex', flexDirection:'row' }}>
      {/* Sidebar */}
      ...
      <div className="flex-1" style={{ minWidth: 0, padding: isMobile ? '12px' : '32px', overflow: 'hidden' }}>
