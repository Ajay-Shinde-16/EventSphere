    ...
    <div className="fade-up" style={{ maxWidth:1200, margin:'0 auto', padding: isMobile ? '16px 12px 24px' : '28px 24px' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns: (isOrg || isMobile) ? '1fr' : '1fr 360px', gap:20 }}>
        ...
        <div style={{ display: isMobile ? 'contents' : 'flex', flexDirection:'column', gap:20, minWidth:0 }}>
          ...
          {/* About */}
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:20, padding:24, order: isMobile ? 1 : 0 }}>
          ...
          {/* Seat Grid */}
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:20, padding:24, order: isMobile ? 2 : 0 }}>
          ...
          {/* Tier pricing cards */}
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:20, padding:24, order: isMobile ? 3 : 0 }}>
          ...
          {!isOrg && (
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:20, padding:24, order: isMobile ? 5 : 0 }}>
          ...
          <div style={{ background:'var(--card-bg)', border:'1px solid var(--border)', borderRadius:20, padding:24, order: isMobile ? 6 : 0 }}>
        ...
        <div style={{ width:'100%', minWidth:0, order: isMobile ? 4 : 0 }}>
          {!isOrg ? (
            /* Booking panel */
