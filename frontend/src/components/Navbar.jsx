...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div style={{
          ...
          <div
            ...
            style={{
              ...
              cursor: 'pointer', flexShrink: 0, userSelect: 'none', marginRight: 4,
            }}>
            <div className="glow-cyan" style={{
              ...
              <i className="bi bi-calendar-event" style={{ color: '#000', fontSize: 15 }} />
            </div>
            <div className="hidden sm:block">
              <div className="grad2 font-grotesk" style={{ fontWeight: 900, fontSize: 14, lineHeight: 1 }}>EventSphere</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            {/* Dark/light toggle */}
            <button style={{ ...iconBtn, color: darkMode ? 'var(--amber)' : 'var(--muted)' }}
            ...
            <div style={{ position: 'relative' }} ref={notifRef}>
              ...
              {notifOpen && (
                <div className="fade-up notif-dropdown" style={{
                  ...
                  {[
                    ...
                    <div key={i}
                      style={{ padding: '12px 18px', display: 'flex', gap: 12, borderBottom: '1px solid var(--border)', cursor: 'pointer' }}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div onClick={() => navigate('/profile')} className="glow-purple"
                  style={{
                    ...
                    fontFamily: "'Space Grotesk',sans-serif", userSelect: 'none', flexShrink: 0,
                  }}>
            ...
            {/* Mobile hamburger */}
            <button className="md:hidden" onClick={() => setMenuOpen(v => !v)} style={{ ...iconBtn }}>
      ...
      {menuOpen && (
        <div className="md:hidden fade-up" style={{
          background: 'var(--surface)',
          borderBottom: '1px solid var(--border)',
          padding: '12px 16px',
          position: 'sticky', top: 66, zIndex: 45,
        }}>
          {navLinks.map(link => (
            ...
            <div style={{ paddingTop: 12, marginTop: 8, borderTop: '1px solid var(--border)' }}>
              <button onClick={() => { logout(); navigate('/'); setMenuOpen(false); }}
                style={{
                  ...
                  color: 'var(--pink)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8,
                }}>
